...
# scp -r ./game-sync.tar.gz $USER@snowy.cs.bris.ac.uk:~/
# ssh $USER@snowy.cs.bris.ac.uk "tar -zxvf ~/game-sync.tar.gz"
...
do
   ssh $USER@$client.users.bris.ac.uk "pkill -f LinuxGame.x86_64 &" &
done
